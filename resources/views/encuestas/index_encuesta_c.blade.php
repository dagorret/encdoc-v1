    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel panel-default">
                    <div class="panel-heading">Formmulario C</div>
                    <div class="panel-body">
                        ...
                        <p class="help-block">Ayuda. Llene la encuesta. Una vez grabada podrá Imprimirla.
                            La encuesta que usted llena no podrá ser editada. Revise bien los datos antes de grabar</p>
                        <div class="panel panel-default">
                            <div class="panel-heading">Nueva Encuesta</div>
                            <div class="panel-body">
                                {!! Form::open(['url' =>  route('ncenc', ['id' => Auth::user()->id]), 'method' => 'post' ])  !!}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    {!! Form::open(['url' =>  route('cbenc', ['id' => $encuesta->id]), 'method' => 'delete' ])  !!}
                                            <button type="submit" class="btn btn-primary btn-sm">Borrar</button>

                                <a href="{{ route('pcenc', ['id' => $encuesta->id]) }}" target="_blank">
